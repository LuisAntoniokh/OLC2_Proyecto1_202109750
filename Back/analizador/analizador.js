...
function peg$parse(input, options) {
  ...
  var peg$e47 = peg$literalExpectation("n", false);
  ...
  var peg$f6 = function(td) { return td };
  ...
  var peg$f11 = function(id, params, block) { return crearNodo('dclFunc', { id, params: params || [], block }) };
  var peg$f12 = function(id, ids) {return ids};
  var peg$f13 = function(id, params) {return [id, ...params]};
  var peg$f14 = function(exp) { return crearNodo('print', { exp }) };
  var peg$f15 = function(block) { return block };
  var peg$f16 = function(cond, iftrue, iffalse) { return iffalse };
  var peg$f17 = function(cond, iftrue, iffalse) { return crearNodo('if', { cond, iftrue, iffalse }) };
  var peg$f18 = function(cond, loop) { return crearNodo('while', {cond, loop})};
  var peg$f19 = function(init, cond, inc, loop) { return crearNodo('for', {init, cond, inc, loop})};
  ...
  var peg$f24 = function(block) { return crearNodo('bloque', { block }) };
  var peg$f25 = function(dcl) { return dcl };
  var peg$f26 = function(exp) { return exp };
  var peg$f27 = function(id, asgn) { return crearNodo('asignacion', {id, asgn} )};
  var peg$f28 = function(id, asgn) { return crearNodo('asignacion', { id, asgn: crearNodo('binaria', { op: '+', izq: crearNodo('referenciaVariable', { id }), der: asgn }) }) };
  var peg$f29 = function(id, asgn) { return crearNodo('asignacion', { id, asgn: crearNodo('binaria', { op: '-', izq: crearNodo('referenciaVariable', { id }), der: asgn }) }) };
  ...
  var peg$f42 = function(num) { return crearNodo('unaria', { op: '-', exp: num }) };
  var peg$f43 = function(num) { return crearNodo('unaria', { op: '!', exp: num }) };
  var peg$f44 = function(callee, args) { return args };
  var peg$f45 = function(callee, params) {
  ...
  var peg$f46 = function(arg, exp) { return exp };
  var peg$f47 = function(arg, args) { return [arg, ...args] };
  var peg$f48 = function() { return text() };
  var peg$f49 = function() {return crearNodo('Primal', { valor: parseFloat(text(), 10), tipo: 'float' })};
  var peg$f50 = function() {return crearNodo('Primal', { valor: parseInt(text(), 10), tipo: 'int' })};
  var peg$f51 = function() {return crearNodo('Primal', { valor: true, tipo: 'bool' })};
  var peg$f52 = function() {return crearNodo('Primal', { valor: false, tipo: 'bool' })};
  var peg$f53 = function(str) { return str };
  var peg$f54 = function() {return crearNodo('Primal', { valor: text().slice(1, -1), tipo: 'char' })};
