...
function peg$parse(input, options) {
  ...
  var peg$e47 = peg$literalExpectation("t", false);
  ...
  var peg$f41 = function(num) { return crearNodo('unaria', { op: '!', exp: num }) };
  var peg$f42 = function(callee, args) { return args };
  var peg$f43 = function(callee, params) {
  ...
  var peg$f44 = function(arg, exp) { return exp };
  var peg$f45 = function(arg, args) { return [arg, ...args] };
  var peg$f46 = function() { return text() };
  var peg$f47 = function() {return crearNodo('Primal', { valor: parseFloat(text(), 10), tipo: 'float' })};
  var peg$f48 = function() {return crearNodo('Primal', { valor: parseInt(text(), 10), tipo: 'int' })};
  var peg$f49 = function() {return crearNodo('Primal', { valor: true, tipo: 'bool' })};
  var peg$f50 = function() {return crearNodo('Primal', { valor: false, tipo: 'bool' })};
  var peg$f51 = function(str) { return str };
  var peg$f52 = function() {return crearNodo('Primal', { valor: text().slice(1, -1), tipo: 'char' })};
  var peg$f53 = function(exp) { return crearNodo('agrupacion', { exp }) };
