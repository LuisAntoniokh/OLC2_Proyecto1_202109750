...
function peg$parse(input, options) {
  ...
  var peg$e37 = peg$classExpectation([["a", "z"], ["A", "Z"], "_"], false, false);
  ...
  var peg$f26 = function(cond, loop) { return crearNodo('while', {cond, loop})};
  var peg$f27 = function(init, cond, inc, loop) { return crearNodo('for', {init, cond, inc, loop})};
  ...
  var peg$f34 = function(id, asgn) { return crearNodo('asignacion', { id, asgn: crearNodo('binaria', { op: '+', izq: crearNodo('referenciaVariable', { id }), der: asgn }) }) };
  var peg$f35 = function(id, asgn) { return crearNodo('asignacion', { id, asgn: crearNodo('binaria', { op: '-', izq: crearNodo('referenciaVariable', { id }), der: asgn }) }) };
  ...
  var peg$f55 = function() {return crearNodo('Primal', { valor: parseFloat(text(), 10), tipo: 'float' })};
  var peg$f56 = function() {return crearNodo('Primal', { valor: parseInt(text(), 10), tipo: 'int' })};
  var peg$f57 = function() {return crearNodo('Primal', { valor: true, tipo: 'bool' })};
  var peg$f58 = function() {return crearNodo('Primal', { valor: false, tipo: 'bool' })};
  var peg$f59 = function(str) { return str };
  var peg$f60 = function() {return crearNodo('Primal', { valor: text().slice(1, -1), tipo: 'char' })};
